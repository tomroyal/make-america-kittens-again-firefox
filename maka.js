// maka.js - part of make america kittens again for FFQ
// v1.0.0
// by Tom Royal
// tomroyal.com
...
// get additional settings from ff storage
		...
		if (img.hasAttribute('makareplaced')){
			...
			blacklist.forEach(function(blist) {
				if ((alttext.indexOf(blist) != -1) || (imgsrc.indexOf(blist) != -1) || (parenttag.indexOf(blist) != -1)){
					...
					img.src = browser.runtime.getURL('/kittens/'+theKittens.kitten[randk].file+'');
					img.width = imgwidth;
